...
public class ModelerModuleLifeCycleHandler extends DefaultModuleLifeCycleHandler {
    ...
    private static final String LATEST_PREDEFINED_TYPES_VERSION = "3.8.04";
    ...
    public boolean start() throws ModuleException {
        ...
        String message = "Modelio/" + this.module.getName() + " " + fullVersion + " - Copyright 2008-2018 Modeliosoft";
    ...
    private void checkPredefinedTypes() {
        ...
        PropertyType floatType = this.module.getModuleContext().getModelingSession().findElementById(PropertyType.class, "bc36b99e-8470-4aee-ba2a-5012c0a17525");
        if (floatType == null) {
            deployModelComponent(modelComponentService);
            return;
        }
    ...
    public void deployModelComponent(final IModelComponentService modelComponentService) {
        File predefinedTypesRamc = new File(this.module.getModuleContext().getConfiguration().getModuleResourcesPath().toFile(), "res/PredefinedTypes.ramc");
