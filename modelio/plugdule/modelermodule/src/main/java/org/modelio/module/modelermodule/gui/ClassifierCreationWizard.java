...
public class ClassifierCreationWizard {
    ...
    public ClassifierCreationWizard(final Instance instance) {
        this.name = "";
    ...
    protected void createContents() {
        ...
        classLabel.setText(I18nMessageService.getString("module.gui.classifierWizard.class"));
    ...
    @objid ("dfc0775d-acf6-44b6-8662-affd668694a1")
