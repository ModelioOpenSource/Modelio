...
public class AttributeCreationWizard {
    ...
    public AttributeCreationWizard(final Classifier classifier, final Instance instance) {
    ...
    private Composite createLines() {
        this.mainGroup = new Composite(this.shell, SWT.BORDER);
        ...
        fd_group.bottom = new FormAttachment(this.composite, 0);
        this.mainGroup.setLayoutData(fd_group);
        ...
        Label creationLabel;
        creationLabel = new Label(this.mainGroup, SWT.NONE);
        ...
        Label valueLabel;
        valueLabel = new Label(this.mainGroup, SWT.NONE);
    ...
    private void createButtons() {
        ...
        this.composite.setLayoutData(fd_composite_1);
    ...
    @objid ("84545bf5-f276-4d07-aabe-dd10870dcac1")
    private void centerOnPrimaryScreen(final Shell parentShell, final Display display) {
