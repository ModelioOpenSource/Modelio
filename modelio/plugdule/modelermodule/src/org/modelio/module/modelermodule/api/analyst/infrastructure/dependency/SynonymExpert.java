...
public class SynonymExpert implements IMdaExpert {
    @objid ("9c6167c4-5643-46b9-aafb-ecf34e2916a9")
    @Override
    ...
    @objid ("f19534e1-21a7-4c5a-b2c8-85e055455c2f")
    @Override
    ...
    @objid ("4d28aa68-c0fa-4afd-9114-118ddea062b0")
    @Override
    ...
    @objid ("29f23b93-7cc0-4d5e-8b4e-dacb18ee9d29")
    @Override
    ...
    @objid ("2ad2e8d4-7c4c-4c91-9667-8d7a90dd9dcd")
    @Override
    ...
    @objid ("b4bc255d-e65d-4eb1-9b7d-869b6496a4f1")
    @Override
