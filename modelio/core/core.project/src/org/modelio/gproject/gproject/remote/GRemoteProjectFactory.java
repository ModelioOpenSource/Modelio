...
public abstract class GRemoteProjectFactory implements IProjectFactory {
    ...
    @Override
    public final ProjectDescriptor getRemoteDescriptor(final ProjectDescriptor localDescriptor, final IAuthData authData, final IModelioProgress monitor) throws IOException, GProjectAuthenticationException {
    ...
    protected void completeDescriptor(final ProjectDescriptor projectDescriptor, final IAuthData authData, final IModelioProgress aProgress) throws IOException, GProjectAuthenticationException {
