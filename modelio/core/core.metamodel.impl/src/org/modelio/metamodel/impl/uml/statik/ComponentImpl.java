...
public class ComponentImpl extends ClassImpl implements Component {
    ...
    @objid ("0de9348c-d10c-4eb6-b828-e8d81afc27ce")
    @Override
    ...
    @objid ("9cb1df68-7158-47e9-a073-1163ef90e9d2")
    @Override
    ...
    @objid ("2195b7c0-825a-4b35-a47b-e61ef3d7508f")
    @Override
