...
/**
 * <p>
 * BPMN metamodel Migrator from Modelio 3.7 v2.2.0 to 3.8 v2.3.0.
 * </p>
...
class BpmnMigratorFromV220 implements IMofRepositoryMigrator {
    ...
    private void fixBpmnDataState(IModelioProgress monitor, IMofSession mofsession) throws MetaclassNotFoundException {
        MofSmObjectImpl stateStereotype = mofsession.getObjectReference(BpmnMigratorFromV220.state_methodologicallink_stereotype);
    ...
    private void fixBpmnDataOutput(IModelioProgress monitor, IMofSession mofsession) throws MetaclassNotFoundException {
        MofSmObjectImpl representsStereotype = mofsession.getObjectReference(BpmnMigratorFromV220.represents_methodologicallink_stereotype);
    ...
    private void fixBpmnCallActivity(IModelioProgress monitor, IMofSession mofsession) throws MetaclassNotFoundException {
        MofSmObjectImpl calledStereotype = mofsession.getObjectReference(BpmnMigratorFromV220.called_methodologicallink_stereotype);
    ...
    private void fixBpmnInterface(IModelioProgress monitor, IMofSession mofsession) throws MetaclassNotFoundException {
        MofSmObjectImpl referenceStereotype = mofsession.getObjectReference(BpmnMigratorFromV220.reference_methodologicallink_stereotype);
    ...
    private void fixBpmnLane(IModelioProgress monitor, IMofSession mofsession) throws MetaclassNotFoundException {
        MofSmObjectImpl partitionElementStereotype = mofsession.getObjectReference(BpmnMigratorFromV220.partitionelement_methodologicallink_stereotype);
