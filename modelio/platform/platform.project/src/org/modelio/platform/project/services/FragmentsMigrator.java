...
public class FragmentsMigrator {
    ...
    public void migrateFragments(final SubMonitor parentMon, final int allowedMonWork) throws InterruptedException {
        ...
        final Shell parentShell = CompletableFuture.supplyAsync(
                DefaultShellProvider::getBestParentShell,
                this.display::syncExec).join();
    ...
    protected void runFragmentMigration(final SubProgress monitor, final BasicMigrationReporter reporter, final IProjectFragment f, final IFragmentMigrator migrator) throws FragmentAuthenticationException, MigrationFailedException, IOException {
