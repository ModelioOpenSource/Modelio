...
public class SmObjectDataSerializer {
    ...
    private SmDependency readDep(SerializerInput in, SmObjectImpl obj, SmClass cls, IModelLoader loader) throws DuplicateObjectException, IOException {
    ...
    private SmObjectImpl readRef(SerializerInput in, IModelLoader loader) throws DuplicateObjectException, IOException {
