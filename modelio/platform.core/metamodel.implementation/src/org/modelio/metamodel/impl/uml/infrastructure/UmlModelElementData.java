...
public class UmlModelElementData extends ModelElementData {
    @objid ("0df834e8-e33e-4f78-bd55-6d779d4f62c5")
     List<SmObjectImpl> mTemplateSubstitution = null;

    @objid ("e04c2be7-823b-46d7-90ef-cde75e21f6e4")
     List<SmObjectImpl> mDefaultParametering = null;

    @objid ("f264c1f7-8a7e-4712-a4b2-d7b73fe97033")
     List<SmObjectImpl> mRepresents = null;

    @objid ("19cbf2fb-c416-4b13-bba2-33c8345e8ab2")
     SmObjectImpl mOwnerTemplateParameter;

    @objid ("c310e4f2-4def-4f28-85bf-6d6ccd1782fd")
     List<SmObjectImpl> mRepresentingEnd = null;

    @objid ("5a2ebb42-0c21-42d9-a209-3cf76aff72d6")
     List<SmObjectImpl> mRepresentingPartition = null;

    @objid ("b37e441d-7aef-4d23-b283-34b42f724028")
     List<SmObjectImpl> mConstraintDefinition = null;

    @objid ("47222f3a-50f2-4b4c-80c8-d28096629e38")
     List<SmObjectImpl> mTypingParameter = null;

    @objid ("cbd76afd-1eb1-4d3d-b0b7-9a1a57af12a0")
     List<SmObjectImpl> mManifesting = null;

    @objid ("cb6436f5-fb83-4e03-8e0e-0cacae8b383b")
     List<SmObjectImpl> mRepresentingInstance = null;

    @objid ("c3aba229-ee35-484c-a20b-22eba20965ce")
     List<SmObjectImpl> mReceivedInfo = null;

    @objid ("e9768c0e-4f25-4037-8246-aa3c7437e3fe")
     List<SmObjectImpl> mSentInfo = null;

    @objid ("5fc49e43-05fd-4f73-a0f3-21ad01a3d208")
     List<SmObjectImpl> mRepresentingConnector = null;

    @objid ("9e521375-eaef-43ed-8459-043d02a4db39")
