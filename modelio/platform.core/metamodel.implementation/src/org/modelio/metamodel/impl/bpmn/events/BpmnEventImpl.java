...
public abstract class BpmnEventImpl extends BpmnFlowNodeImpl implements BpmnEvent {
    @objid ("6c179f09-9471-415b-b72e-9f9fc936b09a")
    @Override
    ...
    @objid ("c73dd559-bdff-49ed-9d97-d2a0e8207d63")
    @Override
    ...
    @objid ("940f92c0-665e-4f33-be5d-7c78a9ea80e3")
    @Override
    ...
    @objid ("4b248293-6657-4fb0-870c-b5dbadddf652")
    @Override
    ...
    @objid ("0d7ef23d-03a3-4839-a0d4-ff76d0c76db0")
    @Override
