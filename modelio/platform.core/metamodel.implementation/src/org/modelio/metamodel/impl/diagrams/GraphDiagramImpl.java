...
import org.modelio.metamodel.impl.diagrams.GraphDiagramData;
...
public class GraphDiagramImpl extends AbstractDiagramImpl implements GraphDiagram {
    @objid ("5366948f-0564-4b0c-91ea-7e1d6ce1c817")
    @Override
    ...
    @objid ("7a17d868-4163-4b78-b6d0-6cafc5a4edda")
    @Override
    ...
    @objid ("1fa7935f-1a4d-4eca-a3fe-b855009048f9")
    @Override
