...
public class FragmentMigrationNeededException extends Exception {
    ...
    private void init(IProjectFragment fragment, MetamodelVersionDescriptor target) {
    ...
    private static String computeMessage(IProjectFragment fragment, MetamodelVersionDescriptor targetVersion) {
        try {
