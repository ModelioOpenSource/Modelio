...
public class ChainedMofFragmentMigrator implements IFragmentMigrator, org.modelio.gproject.fragment.migration.IFragmentMigrator.IMigrationProcess {
    ...
    protected final MofSession prepareMofSession(IModelioProgress monitor, int migratorIndex) throws FragmentAuthenticationException, IOException, MofMigrationException {
