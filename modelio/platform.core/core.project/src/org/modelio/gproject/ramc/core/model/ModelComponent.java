...
public class ModelComponent implements Comparable<ModelComponent>, IModelComponent {
    ...
    private static class Loader {
        ...
        public static TreeSet<Element> getManifested(Artifact ramc) {
            ...
            CoreSession session = CoreSession.getSession(ramc);
    ...
    private static class Writer {
        ...
        public static void setManifestedElements(Artifact ramc, Set<Element> manifestedElements) {
            Set<Element> toManifest = new HashSet<>(manifestedElements);
        ...
        public static void setVersion(Artifact ramc, Version version) {
            ...
            try {
                TaggedValue taggedValue = ramc.getTag(ModelComponent.MODELER_MODULE, "ModelComponentVersion");
                if (taggedValue == null) {
                    IInfrastructureModelFactory factory = Writer.getInfrastructureModelFactory(ramc);
        ...
        public static void setProvider(Artifact ramc, String provider) {
            try {
                TaggedValue taggedValue = ramc.getTag(ModelComponent.MODELER_MODULE, "ModelComponentProvider");
                if (taggedValue == null) {
                    IInfrastructureModelFactory factory = Writer.getInfrastructureModelFactory(ramc);
