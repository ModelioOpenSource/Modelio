...
import org.modelio.diagram.editor.bpmn.layout.ILayoutableLink.AnchorDirection;
...
public class SimpleLayoutableNode implements ILayoutableNode {
    ...
    private Map<org.modelio.diagram.editor.bpmn.layout.ILayoutableLink.AnchorDirection, List<ILayoutableLink>> inLinks = new HashMap<>();

    @objid ("44941f8e-dc65-4c69-90bb-9d238cea0859")
    private Map<org.modelio.diagram.editor.bpmn.layout.ILayoutableLink.AnchorDirection, List<ILayoutableLink>> outLinks = new HashMap<>();
