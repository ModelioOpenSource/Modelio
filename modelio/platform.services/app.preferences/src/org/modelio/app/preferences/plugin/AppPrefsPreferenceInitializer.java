...
/**
 * {@link AbstractPreferenceInitializer Preference initializer} that scans 'org.modelio.app.preferences' extension points for initializations.
 * <p>
...
public class AppPrefsPreferenceInitializer extends AbstractPreferenceInitializer {
    @objid ("862187a1-323e-4ffa-be35-47f90d44fe5b")
    private static final String PREFS_XP = "org.modelio.app.preferences";
    ...
    public void initializeDefaultPreferences() {
        ...
        try {
            ...
            IPersistentPreferenceStore preferences = AppPreferences.getPreferences();
        
            AppPreferences.LOG.debug("Initializing '%s' plugin preferences ...",AppPreferences.PLUGIN_ID);
        
            for (final IConfigurationElement elmt : new ExtensionPointContributionManager(PREFS_XP)
                    .getExtensions(ELMT_INIT)) {
                AppPreferences.LOG.debug(" - Initializing default values from '%s'...",elmt.getContributor().getName());
                ...
                for (IConfigurationElement prefEl : elmt.getChildren(ELMT_PREF)) {
                    ...
                    AppPreferences.LOG.debug("   - default pref value '%s'='%s'", key, val);
