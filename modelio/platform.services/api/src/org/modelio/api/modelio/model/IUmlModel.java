...
public interface IUmlModel {
    ...
    @Deprecated
    Document createExternDocument(String moduleName, final String documentRole, final ModelElement owner, final String mimeType) throws ExtensionNotFoundException, IOException;
    ...
    @Deprecated
    Document createExternDocument(String moduleName, String documentRole, ModelElement owner, String mimeType, Path initialContent) throws ExtensionNotFoundException, IOException;
