...
public interface IDiagramLink extends IDiagramGraphic {
    ...
    /**
     * Link extension roles for {@link IDiagramLink#getExtensions(ExtensionRole)}
     * and  {@link IDiagramLink#getFirstExtension(ExtensionRole)}.
     * @since 3.5
     */
    ...
    enum ExtensionRole {
        ...
        EDGE_GUARD,
        /**
         * <p>Main label on source side</p>
         */
        FROM_MAIN,
        /**
         * <p>Secondary label on source side.</p><p>For example cardinality label on association role.</p>
         */
        FROM_AUX,
        /**
        ...
        /**
         * <p>Target side main label.</p>
         */
        TO_MAIN,
        /**
         * <p>Target side secondary label.</p>
         */
        TO_AUX,
        /**
