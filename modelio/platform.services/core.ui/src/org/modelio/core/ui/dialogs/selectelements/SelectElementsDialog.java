...
public class SelectElementsDialog extends ModelioDialog {
    ...
    public SelectElementsDialog(Shell parentShell, ICoreSession session, ISearchEngine searcher, ISearchCriteria searchCriteria, String titleKey, List<MObject> selection, boolean autorunSearch) {
        super(parentShell);
