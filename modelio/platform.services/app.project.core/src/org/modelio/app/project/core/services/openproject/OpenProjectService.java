...
public class OpenProjectService implements IProjectOpener {
    ...
    @Override
    public void openProject(final ProjectDescriptor projectToOpen, final IAuthData authData, final boolean runInBatchMode, final IProgressMonitor monitor) throws GProjectAuthenticationException, IOException, InterruptedException {
