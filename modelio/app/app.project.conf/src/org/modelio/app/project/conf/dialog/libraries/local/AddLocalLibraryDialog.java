...
public final class AddLocalLibraryDialog extends ModelioDialog {
    ...
    public void addButtonsInButtonBar(Composite parent) {
        ...
        this.addBtn = createButton(parent, Window.OK, AppProjectConf.I18N.getString("AddLocalLibraryDialog.AddFragment"), true); //$NON-NLS-1$
    ...
    @Override
    public void init() {
        getShell().setText(AppProjectConf.I18N.getString("AddLocalLibraryDialog.ShellTitle")); //$NON-NLS-1$
    ...
    protected String getHelpId() {
        return AppProjectConf.I18N.getString("AddLocalLibraryDialog.HelpId");
    }
