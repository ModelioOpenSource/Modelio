...
public final class DistantLibraryDialog extends ModelioDialog {
    ...
    public void addButtonsInButtonBar(Composite parent) {
        if (this.editedFragment == null) {
            ...
            this.addButton = createButton(parent, Window.OK, AppProjectConf.I18N.getString("DistantLibraryDialog.AddFragment"), true); //$NON-NLS-1$
            this.addButton.setEnabled(false);
        } else if (this.isLocalFragment) {
            createButton(parent, Window.CANCEL, IDialogConstants.CANCEL_LABEL, true);
            this.editButton = createButton(parent, Window.OK, AppProjectConf.I18N.getString("DistantLibraryDialog.EditFragment"), true); //$NON-NLS-1$
    ...
    public void init() {
        if (this.editedFragment == null) {
            getShell().setText(AppProjectConf.I18N.getString("DistantLibraryDialog.ShellAddTitle")); //$NON-NLS-1$
            ...
            getShell().setText(AppProjectConf.I18N.getString("DistantLibraryDialog.ShellEditTitle")); //$NON-NLS-1$
    ...
    protected String getHelpId() {
        return AppProjectConf.I18N.getString("DistantLibraryDialog.HelpId");
    }
