...
class UpdateLocalLibraryDialog extends ModelioDialog {
    ...
    public UpdateLocalLibraryDialog(Shell parentShell, UpdatePanelDataModel model) {
        super(parentShell);
        this.model = model;
    }
    ...
    public void addButtonsInButtonBar(Composite parent) {
        createButton(parent, OK, AppProjectConf.I18N.getString("UpdateLocalLibraryDialog.Update"), true);
        createButton(parent, CANCEL, AppProjectConf.I18N.getString("UpdateLocalLibraryDialog.Close"), true);
    }

    @objid ("8bd48fe2-c5fa-4494-9104-a8036e1a35f1")
    @Override
    public void init() {
        getShell().setText(AppProjectConf.I18N.getString("UpdateLocalLibraryDialog.ShellTitle")); //$NON-NLS-1$ );
        setTitle(AppProjectConf.I18N.getString("UpdateLocalLibraryDialog.Title")); //$NON-NLS-1$
        
        setMessage(AppProjectConf.I18N.getMessage("UpdateLocalLibraryDialog.Message")); //$NON-NLS-1$
