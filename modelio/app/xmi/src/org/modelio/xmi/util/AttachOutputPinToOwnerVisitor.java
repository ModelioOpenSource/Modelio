...
public class AttachOutputPinToOwnerVisitor {
    ...
    @objid ("f0189d01-faff-44c9-af34-3fe60ed4144b")
    ...
    private class OutputPinLinker extends UMLSwitch<Object> {
        ...
        public Object caseAcceptCallAction(org.eclipse.uml2.uml.AcceptCallAction owner) {
            if ((owner.getReturnInformation() == null)
                    && (AttachOutputPinToOwnerVisitor.this._obOutputPin.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2RETURNINFORMATION))){   
        ...
        public Object caseAcceptEventAction(org.eclipse.uml2.uml.AcceptEventAction owner) {
            if (AttachOutputPinToOwnerVisitor.this._obOutputPin.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2RESULT)){   
        ...
        public Object caseCreateLinkObjectAction(org.eclipse.uml2.uml.CreateLinkObjectAction owner) {
            if ((owner.getResult() == null)
                    && (AttachOutputPinToOwnerVisitor.this._obOutputPin.isStereotyped(XMIProperties.modelerModuleName, IModelerModuleStereotypes.UML2RESULT))){   
