...
class RelationGenerator {
    ...
    private String getSourceId(MObject element, MDependency dependency) {
        if (IdGenerator.getInstance().exists(element)) {
            return "this.elements.get(" + IdGenerator.getInstance().getId(element) + ").mGet(this.elements.get("
    ...
    private String getDestinationId(MObject source, MObject element) {
        ...
        if (element instanceof Stereotype) {
            ...
            return "this.metamodel.getStereotype(\"" + moduleName + "\",\"" + stereotype.getName() + "\",Metamodel.getMClass(" + source.getMClass().getJavaInterface().getName() + ".class))";
        }
        ...
        if (element instanceof TagType) {
            ...
            String moduleName = module != null ? module.getName() : ".*";
            this.report.addModuleDependency(module);
            return "this.metamodel.getTagType(\"" + moduleName + "\",\"" + tagtype.getName() + "\",Metamodel.getMClass(" + source.getCompositionOwner().getMClass().getJavaInterface().getName() + ".class))";
        }
        ...
        if (element instanceof NoteType) {
            ...
            String moduleName = module != null ? module.getName() : ".*";
            this.report.addModuleDependency(module);
            return "this.metamodel.getNoteType(\"" + moduleName + "\",\"" + notetype.getName() + "\",Metamodel.getMClass(" + source.getCompositionOwner().getMClass().getJavaInterface().getName() + ".class))";
        }
        ...
        if (element instanceof ResourceType) {
            ...
            String moduleName = module != null ? module.getName() : ".*";
            this.report.addModuleDependency(module);
            return "this.metamodel.getExternDocumentType(\"" + moduleName + "\",\"" + resourceType.getName() + "\",Metamodel.getMClass(" + source.getCompositionOwner().getMClass().getJavaInterface().getName() + ".class))";
        }
        ...
        if (element instanceof PropertyTableDefinition) {
            ...
            if (stereotype != null) {
                ModuleComponent module = stereotype.getModule();
                this.report.addModuleDependency(module);
                return "(" + element.getMClass().getJavaInterface().getName()
                        + ")session.findElementById(Metamodel.getJavaInterface(Metamodel.getMClass(" + element.getMClass().getJavaInterface().getName()
                        + ".class)),\"" + element.getUuid().toString() + "\")";
            }
        }
