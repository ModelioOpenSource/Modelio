...
package org.modelio.app.ui.project;
...
public class ProjectToolbar extends TrimBarComponent {
    ...
    @objid ("936badff-10ce-4d52-ab72-a885a78f340d")
    private static final Image OPENCONFIGURATOR;

    @objid ("d6156d62-aecc-455c-9fbc-20177c00bdbc")
    private static final Image REDO;

    @objid ("b62a37cb-ed1b-4bcd-aca8-7ac7757915b3")
    private static final Image SAVE;

    @objid ("3aaa9de3-7a0d-4a96-a7c8-8f473c4b87dc")
    private static final Image UNDO;

    @objid ("775ad67b-5991-4a56-af61-4e59be0a13d6")
    @Inject
    private ECommandService commandService;

    @objid ("fd5643a6-96f8-4c8d-90ce-7832408a9e59")
    @Inject
     ...
     */
    @objid ("7aa01aa3-aa2c-43a7-93ce-240148890cce")
    ...
    @objid ("0954e2fc-0f08-4f58-8097-80c0af4f2db6")
    @Inject
    private EHandlerService handlerService;

    @objid ("168d5e4c-e8d6-4c66-bf38-181f192eaa60")
    @Inject
    @Optional
    private MPart part;
    ...
    public ProjectToolbar() {
        super(AppUi.I18N.getString("ProjectToolbar.ProjectZone.label"));
    }
    ...
    protected Control createControl(Composite parent) {
        TrimBarLayout layout = (TrimBarLayout) parent.getParent().getLayout();
    ...
    private ToolItem createOpenConfiguratorToolItem(ToolBar toolBar) {
        // Create a new handled item
        ToolItem item = new ToolItem(toolBar, SWT.PUSH);
        
        // Set tooltip and icon
        item.setToolTipText(AppUi.I18N.getString("ProjectToolbar.OpenConfigurator.tooltip"));
        item.setImage(ProjectToolbar.OPENCONFIGURATOR);
        
        // Get the e4 command
        ParameterizedCommand command = ProjectToolbar.this.commandService.createCommand(ProjectToolbar.OPENCONFIGURATOR_COMMAND_ID, new HashMap<>());
    ...
    private ToolItem createRedoToolItem(ToolBar toolBar) {
        // Create a new handled item
        ToolItem item = new ToolItem(toolBar, SWT.PUSH);
        
        // Set tooltip and icon
        item.setToolTipText(AppUi.I18N.getString("ProjectToolbar.Redo.tooltip"));
        item.setImage(ProjectToolbar.REDO);
        
        // Get the e4 command
        ParameterizedCommand command = ProjectToolbar.this.commandService.createCommand(ProjectToolbar.REDO_COMMAND_ID, new HashMap<>());
        item.setData(command);
    ...
    private ToolItem createSaveToolItem(ToolBar toolBar) {
        // Create a new handled item
        ToolItem item = new ToolItem(toolBar, SWT.PUSH);
        
        // Set tooltip and icon
        item.setToolTipText(AppUi.I18N.getString("ProjectToolbar.Save.tooltip"));
        item.setImage(ProjectToolbar.SAVE);
        
        // Get the e4 command
        ParameterizedCommand command = ProjectToolbar.this.commandService.createCommand(ProjectToolbar.SAVE_COMMAND_ID, new HashMap<>());
        item.setData(command);
    ...
    private ToolItem createUndoToolItem(ToolBar toolBar) {
        // Create a new handled item
        ToolItem item = new ToolItem(toolBar, SWT.PUSH);
        
        // Set tooltip and icon
        item.setToolTipText(AppUi.I18N.getString("ProjectToolbar.Undo.tooltip"));
        item.setImage(ProjectToolbar.UNDO);
        
        // Get the e4 command
        ParameterizedCommand command = ProjectToolbar.this.commandService.createCommand(ProjectToolbar.UNDO_COMMAND_ID, new HashMap<>());
        item.setData(command);
    ...
    @Inject
    @Optional
    private void onProjectSaved(@SuppressWarnings("unused") @EventTopic(ModelioEventTopics.PROJECT_SAVED) GProject project) {
        refreshStatus();
    }


static {
        ImageDescriptor image1 = AbstractUIPlugin.imageDescriptorFromPlugin(AppUi.PLUGIN_ID, "icons/save.png");
        if (image1 != null) {
        ...
        ImageDescriptor image2 = AbstractUIPlugin.imageDescriptorFromPlugin(AppUi.PLUGIN_ID, "icons/undo.png");
        if (image2 != null) {
        ...
        ImageDescriptor image3 = AbstractUIPlugin.imageDescriptorFromPlugin(AppUi.PLUGIN_ID, "icons/redo.png");
        if (image3 != null) {
        ...
        ImageDescriptor image4 = AbstractUIPlugin.imageDescriptorFromPlugin(AppUi.PLUGIN_ID, "icons/config.png");
        if (image4 != null) {
