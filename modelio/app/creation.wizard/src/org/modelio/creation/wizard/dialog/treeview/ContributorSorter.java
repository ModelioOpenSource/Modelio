...
public class ContributorSorter extends ViewerComparator {
    ...
    public int compare(Viewer viewer, Object e1, Object e2) {
        ...
        if (e1 instanceof Category && e2 instanceof Category) {
            ...
            boolean isStandardE1 = contributor1.getClass().getPackage().getName().equals("org.modelio.diagram.editor.statik.contributor");
            boolean isStandardE2 = contributor2.getClass().getPackage().getName().equals("org.modelio.diagram.editor.statik.contributor");
